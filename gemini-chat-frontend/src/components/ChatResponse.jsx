          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <div>
                ...
                <p style={{ fontWeight: '500' }}>{usageMetadata.promptTokenCount}</p>
              </div>
              <div>
                <p style={{ color: '#6b7280' }}>Response Tokens</p>
                <p style={{ fontWeight: '500' }}>{usageMetadata.candidatesTokenCount}</p>
              </div>
              <div>
                <p style={{ color: '#6b7280' }}>Total Tokens</p>
                <p style={{ fontWeight: '500' }}>{usageMetadata.totalTokenCount}</p>
              </div>
            </div>
          </div>
        </div>
